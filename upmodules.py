...
print("The database is running on ip "+database_ip+":"+str(database_infos['internalport'])+" and on localhost:"+str(database_infos['port']))
...
for app in apps_infos:
	...
	print("The "+app['name']+" app is running on ip "+app_ip+":"+str(app['internalport'])+" and on localhost:"+str(app['port']))
